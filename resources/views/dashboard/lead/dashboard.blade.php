...
@section('pageTitle','Copa Tech - Lead Dashboard')
        ...
        <div class="card bg-gradient-primary border-0">
          <div class="card-body">
            ...
            <p class="mt-3 mb-0 text-sm">
              <a href="{{ route('lead.user.index') }}" class="text-nowrap text-white font-weight-600">See details</a>
            </p>
          </div>
        </div>
      </div>
      <div class="col-xl-3 col-md-6">
        <div class="card bg-gradient-info border-0">
          <div class="card-body">
            ...
            <p class="mt-3 mb-0 text-sm">
              <a href="{{ route('lead.workshop.index') }}" class="text-nowrap text-white font-weight-600">See details</a>
            </p>
          </div>
        </div>
      </div>
          ...
          <div class="card-body">
            <div class="row">
              <div class="col">
                ...
                <span class="h2 font-weight-bold mb-0 text-white">{{ $projects->count() }}</span>
              </div>
            </div>
            <p class="mt-3 mb-0 text-sm">
              <a href="{{ route('lead.project.index') }}" class="text-nowrap text-white font-weight-600">See details</a>
            </p>
          </div>
        </div>
      </div>
      <div class="col-xl-3 col-md-6">
        <div class="card bg-gradient-default border-0">
          <div class="card-body">
            ...
            <p class="mt-3 mb-0 text-sm">
              <a href="{{ route('lead.story.index') }}" class="text-nowrap text-white font-weight-600">See details</a>
            </p>
          </div>
        </div>
      </div>
