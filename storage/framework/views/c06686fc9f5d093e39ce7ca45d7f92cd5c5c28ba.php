  ...
  <section class="mx-4">
    ...
    <div class="container">
      <div class="justify-content-center">
        <div id="intro">
          <p>Thank you for choosing to be part of our community at Copa Tech Club (“Community”, “we”, “us”, or “our”). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about our policy, or our practices with regards to your personal information, please contact us at <a href="mailto:contact@CopaTech.com" target="_blank">contact@CopaTech.com</a>.</p>
          <p>When you visit our website <a href="https://CopaTech.com" target="blank">https://CopaTech.com</a> and use our services, you trust us with your personal information. We take your privacy very seriously. In this privacy policy, we seek to explain to you in the clearest way possible what information we collect, how we use it and what rights you have in relation to it. We hope you take some time to read through it carefully, as it is important. If there are any terms in this privacy policy that you do not agree with, please discontinue use of our Sites and our services.</p>
          <p>This privacy policy applies to all information collected through our website (<a href="https://CopaTech.com" target="blank">https://CopaTech.com</a>), and/or any related services, marketing or events (we refer to them collectively in this privacy policy as the "Services").</p>
        ...
        <div id="info-we-collect">
          ...
          <p><em>In Short:  We collect personal information that you provide to us such as name, contact information, passwords and security data, and social media login data.</em></p>
          ...
          <p>The personal information that we collect depends on the context of your interactions with us and the Services, the choices you make and the services and features you use. The personal information we collect can include the following:</p>
          <p>
            <ul>
              <li>Publicly Available Personal Information. We collect first name, maiden name, last name, and nickname; phone numbers; email addresses; social media; and other similar data.</li>
              <li>Credentials. We collect passwords, and similar security information used for authentication and account access.</li>
              <li>Social Media Login Data. We provide you with the option to register using social media account details, like your Google, GitHub or other social media account. If you choose to register in this way, we will collect the Information described in the section called "<a href="#social-logins">HOW DO WE HANDLE YOUR SOCIAL LOGINS?</a>" below.</li>
            </ul>
          </p>
          <p>All personal information that you provide to us must be true, complete and accurate, and you must notify us of any changes to such personal information.</p>
          <h5>Information automatically collected</h5>
          <p><em>In Short:   Some information — such as IP address and/or browser and device characteristics — is collected automatically when you visit our Services.</em></p>
          <p>We automatically collect certain information when you visit, use or navigate the Services. This information does not reveal your specific identity (like your name or contact information) but may include device and usage information, such as your IP address, browser and device characteristics, operating system, language preferences, referring URLs, device name, country, location, information about how and when you use our Services and other technical information. This information is primarily needed to maintain the security and operation of our Services, and for our internal analytics and reporting purposes.</p>
          <p>Like many communities, we also collect information through cookies and similar technologies.</p>
          ...
          <p><em>In Short:   We may collect limited data from public databases, marketing partners, social media platforms, and other outside sources.</em></p>
        ...
        <div id="info-we-use">
          ...
          <p><em>In Short:  We process your information for purposes based on legitimate community interests, the fulfillment of our contract with you, compliance with our legal obligations, and/or your consent.</em></p>
          <p>We use personal information collected via our Services for a variety of community purposes described below. We process your personal information for these purposes in reliance on our legitimate community interests, in order to enter into or perform a contract with you, with your consent, and/or for compliance with our legal obligations. We indicate the specific processing grounds we rely on next to each purpose listed below.</p>
          <p>
            We use the information we collect or receive:
            <ul>
              <li>To facilitate account creation and logon process. If you choose to link your account with us to a third party account (such as your Google or GitHub account), we use the information you allowed us to collect from those third parties to facilitate account creation and logon process for the performance of the contract. See the section below headed "<a href="#social-logins">HOW DO WE HANDLE YOUR SOCIAL LOGINS?</a>" for further information.</li>
              ...
              <li>To enforce our terms, conditions and policies for Community Purposes, Legal Reasons and Contractual.</li>
              ...
              <li>For other Community Purposes. We may use your information for other Community Purposes, such as data analysis, identifying usage trends, determining the effectiveness of our promotional campaigns and to evaluate and improve our Services, marketing and your experience. We may use and store this information in aggregated and anonymized form so that it is not associated with individual end users and does not include personal information. We will not use identifiable personal information without your consent.</li>
            </ul>
          </p>
        </div>
        ...
        <div id="info-we-share">
          ...
          <p><em>In Short:  We only share information with your consent, to comply with laws, to provide you with services, to protect your rights, or to fulfill community obligations.</em></p>
          <p>
            ...
            <ul>
              ...
              <li>Legitimate Interests: We may process your data when it is reasonably necessary to achieve our legitimate community interests.</li>
        ...
        <div id="privacy-right">
          ...
          <p>If you have questions or comments about your privacy rights, you may email us at <a href="mailto:contact@CopaTech.com" target="_blank">contact@CopaTech.com</a>.</p>
        ...
        <div id="policy-contact">
          ...
          <p><em>If you have questions or comments about this policy, you may email us at <a href="mailto:contact@CopaTech.com" target="_blank">contact@CopaTech.com</a> or by post to:</em></p>
          <p>Copa Tech Club,<br>Copa Tech, co-operative university,<br> Nairobi 00502,<br>Nairobi.</p>
        </div>

        <div>
          <h4>HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h4>
          <p><em>Based on the laws of some countries, you may have the right to request access to the personal information we collect from you, change that information, or delete it in some circumstances. To request to review, update, or delete your personal information, please send a mail to <a href="mailto:contact@CopaTech.com" target="_blank">contact@CopaTech.com</a>. We will respond to your request within 30 days.</em></p>
        </div>
      </div>
    </div>
  </section>
...
<?php echo $__env->make('web.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mihz\Desktop\cuktech\resources\views/web/privacy.blade.php ENDPATH**/ ?>