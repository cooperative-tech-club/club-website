...
class ProjectController extends Controller
{
  ...
  {
    return view('dashboard.lead.projects.index', ['projects' => $model->with(['tags', 'category'])->get()]);
  }
  ...
  {
    return view('dashboard.lead.projects.create', [
  ...
  public function store(ProjectRequest $request, Project $model)
  {
    ...
    return redirect()->route('lead.project.index')->withStatus(__('Project successfully created.'));
  }
  ...
  {
    return view('dashboard.lead.projects.edit', [
  ...
  public function update(ProjectRequest $request, Project $project)
  {
    ...
    return redirect()->route('lead.project.index')->withStatus(__('Project successfully updated.'));
  }
  ...
  public function destroy(Project $project)
  {
    ...
    return redirect()->route('lead.project.index')->withStatus(__('Project successfully deleted.'));
  }
}
