<?php $__env->startSection('pageTitle','Copa Tech - Edit Category'); ?>
    ...
    <div class="row">
      <div class="col-xl-12 order-xl-1">
        <div class="card">
          ...
          <div class="card-body">
            <form method="post" action="<?php echo e(route('media.category.update', $category)); ?>" autocomplete="off">
              <?php echo csrf_field(); ?>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mihz\Desktop\aekiti\resources\views/dashboard/media/categories/edit.blade.php ENDPATH**/ ?>