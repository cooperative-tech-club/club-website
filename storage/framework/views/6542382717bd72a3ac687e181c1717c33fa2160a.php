<?php $__env->startSection('pageTitle','Copa Tech - Events Management'); ?>
...
<?php $__env->startSection('content'); ?>
  <?php $__env->startComponent('dashboard.layouts.headers.auth'); ?>
    <?php $__env->startComponent('dashboard.layouts.headers.breadcrumbs'); ?>
      <li class="breadcrumb-item"><a href="<?php echo e(route('communication.workshop.index')); ?>"><?php echo e(__('Events Management')); ?></a></li>
            ...
            <div class="row align-items-center">
              <div class="col-8">
                ...
                <p class="text-sm mb-0">
                  <?php echo e(__('all year round events, conferences and trainings.')); ?>

                </p>
              </div>
              <div class="col-4 text-right">
                <a href="<?php echo e(route('communication.workshop.create')); ?>" class="btn btn-sm btn-primary"><?php echo e(__('Add Events')); ?></a>
              </div>
            </div>
          </div>
                    ...
                    <td class="text-right">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <a class="dropdown-item" href="<?php echo e(route('communication.workshop.edit', $workshop)); ?>"><?php echo e(__('Edit')); ?></a>
                          <form action="<?php echo e(route('communication.workshop.destroy', $workshop)); ?>" method="post">
                            <?php echo csrf_field(); ?>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mihz\Desktop\club-website\resources\views/dashboard/communication/workshops/index.blade.php ENDPATH**/ ?>