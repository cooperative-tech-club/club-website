...
class TeamController extends Controller
{
  ...
  {
    return view('dashboard.communication.teams.index', ['teams' => $model->with('user')->get()]);
  }
  ...
  {
    return view('dashboard.communication.teams.create', ['users' => $userModel->get(['id', 'name', 'email'])]);
  }
  ...
  public function store(TeamRequest $request, Team $model)
  {
    ...
    return redirect()->route('communication.team.index')->withStatus(__('Team member successfully created.'));
  }
  ...
  {
    return view('dashboard.communication.teams.edit', [
  ...
  public function update(TeamRequest $request, Team $team)
  {
    ...
    return redirect()->route('communication.team.index')->withStatus(__('Team member successfully updated.'));
  }
  ...
  public function destroy(Team $team)
  {
    ...
    return redirect()->route('communication.team.index')->withStatus(__('Team member successfully deleted.'));
  }
}
