          ...
          <div class="card-header">
            <div class="row align-items-center">
              ...
              <div class="col-4 text-right">
                <a href="<?php echo e(route('lead.project.create')); ?>" class="btn btn-sm btn-primary"><?php echo e(__('Add project')); ?></a>
              </div>
            </div>
          </div>
                    ...
                    <td class="text-right">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <a class="dropdown-item" href="<?php echo e(route('lead.project.edit', $project)); ?>"><?php echo e(__('Edit')); ?></a>
                          <form action="<?php echo e(route('lead.project.destroy', $project)); ?>" method="post">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard.layouts.app', [
  ...
  'parentSection' => 'site',
  'elementName' => 'project'
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mihz\Desktop\aekiti\resources\views/dashboard/lead/projects/index.blade.php ENDPATH**/ ?>