...
class TrackController extends Controller
{
  ...
  {
    return view('dashboard.member.tracks.index', ['tracks' => $model->with('tags')->get()]);
  }
  ...
  {
    return view('dashboard.member.tracks.create', ['tags' => $tagModel->get(['id', 'name'])]);
  }
  ...
  public function store(TrackRequest $request, Track $model)
  {
    ...
    return redirect()->route('member.track.index')->withStatus(__('Track successfully created.'));
  }
  ...
  {
    return view('dashboard.member.tracks.edit', [
  ...
  public function update(TrackRequest $request, Track $track)
  {
    ...
    return redirect()->route('member.track.index')->withStatus(__('Track successfully updated.'));
  }
  ...
  public function destroy(Track $track)
  {
    ...
    return redirect()->route('member.track.index')->withStatus(__('Track successfully deleted.'));
  }
}
