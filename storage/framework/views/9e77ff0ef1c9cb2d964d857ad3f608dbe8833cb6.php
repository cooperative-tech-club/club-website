<?php $__env->startSection('pageTitle','Copa Tech - Add Workshop'); ?>
...
<?php $__env->startSection('content'); ?>
  <?php $__env->startComponent('dashboard.layouts.headers.auth'); ?>
    <?php $__env->startComponent('dashboard.layouts.headers.breadcrumbs'); ?>
      <li class="breadcrumb-item"><a href="<?php echo e(route('lead.workshop.index')); ?>"><?php echo e(__('Workshop Management')); ?></a></li>
      <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('Add Workshop')); ?></li>
          ...
          <div class="card-header">
            <div class="row align-items-center">
              ...
              <div class="col-4 text-right">
                <a href="<?php echo e(route('lead.workshop.index')); ?>" class="btn btn-sm btn-primary"><?php echo e(__('Back to list')); ?></a>
              </div>
            </div>
          </div>
          <div class="card-body">
            <form method="post" class="item-form" action="<?php echo e(route('lead.workshop.store')); ?>" autocomplete="off" enctype="multipart/form-data">
              <?php echo csrf_field(); ?>
              ...
              <div class="pl-lg-4">
                ...
                <div class="form-group<?php echo e($errors->has('venue_id') ? ' has-danger' : ''); ?>">
                  ...
                  <select name="venue_id" id="input-role" class="form-control<?php echo e($errors->has('venue_id') ? ' is-invalid' : ''); ?>" >
                    ...
                    <?php $__currentLoopData = $venues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $venue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($venue->id); ?>" <?php echo e($venue->id == old('venue_id') ? 'selected' : ''); ?>><?php echo e($venue->name); ?></option>
                ...
                <div class="form-group<?php echo e($errors->has('description') ? ' has-danger' : ''); ?>">
                  ...
                  <textarea name="description" id="compose-textarea" class="form-control<?php echo e($errors->has('description') ? ' is-invalid' : ''); ?>" style="height: 300px" <?php echo e(__('Description')); ?>><?php echo e(old('description')); ?></textarea>
                ...
                <div class="form-group<?php echo e($errors->has('status') ? ' has-danger' : ''); ?>">
                  ...
                  <select name="status" id="input-status" class="form-control<?php echo e($errors->has('status') ? ' is-invalid' : ''); ?>" >
                    ...
                    <?php $__currentLoopData = config('aekiti.workshops.status'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($value); ?>" <?php echo e($value == old('status') ? 'selected' : ''); ?>><?php echo e($status); ?>(<?php echo e($value); ?>)</option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
                ...
                <div class="form-group<?php echo e($errors->has('mode') ? ' has-danger' : ''); ?>">
                  ...
                  <select name="mode" id="input-mode" class="form-control<?php echo e($errors->has('mode') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Venue')); ?>" >
                    ...
                    <?php $__currentLoopData = config('aekiti.workshops.mode'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $mode): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($value); ?>" <?php echo e($value == old('mode') ? 'selected' : ''); ?>><?php echo e($mode); ?>(<?php echo e($value); ?>)</option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
                ...
                <div class="form-group<?php echo e($errors->has('link') ? ' has-danger' : ''); ?>">
                  ...
                  <input type="url" name="link" id="input-link" class="form-control<?php echo e($errors->has('link') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Registration Link')); ?>" value="<?php echo e(old('link')); ?>">
                ...
                <div class="form-group<?php echo e($errors->has('youtube') ? ' has-danger' : ''); ?>">
                  ...
                  <input type="url" name="youtube" id="input-youtube" class="form-control<?php echo e($errors->has('youtube') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Youtube')); ?>" value="<?php echo e(old('youtube')); ?>">
                ...
                <div class="form-group<?php echo e($errors->has('slide') ? ' has-danger' : ''); ?>">
                  ...
                  <input type="url" name="slide" id="input-slide" class="form-control<?php echo e($errors->has('slide') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Slide')); ?>" value="<?php echo e(old('slide')); ?>">
                ...
                <div class="form-group<?php echo e($errors->has('photo') ? ' has-danger' : ''); ?>">
                  ...
                  <input type="url" name="photo" id="input-photo" class="form-control<?php echo e($errors->has('photo') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Photo')); ?>" value="<?php echo e(old('photo')); ?>">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input class="form-control date" name="end_date" id="end_date" type="datetime" value="<?php echo e(old('end_date')); ?>">
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mihz\Desktop\aekiti\resources\views/dashboard/lead/workshops/create.blade.php ENDPATH**/ ?>