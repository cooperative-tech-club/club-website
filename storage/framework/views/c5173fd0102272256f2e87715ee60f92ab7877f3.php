      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        <ul class="navbar-nav">
          <li class="nav-item <?php echo e($elementName == 'dashboard' ? 'active' : ''); ?>">
            <a class="nav-link" href="<?php echo e(route('facilitator.dashboard')); ?>">
              <i class="ni ni-shop text-primary"></i>
              <span class="nav-link-text"><?php echo e(__('Dashboard')); ?></span>
            </a>
          </li>
          <li class="nav-item <?php echo e($elementName == 'profile' ? 'active' : ''); ?>">
            <a class="nav-link" href="<?php echo e(route('facilitator.profile.edit')); ?>">
...
<?php /**PATH C:\Users\mihz\Desktop\aekiti\resources\views/dashboard/facilitator/layouts/nav/sidebar.blade.php ENDPATH**/ ?>