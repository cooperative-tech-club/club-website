...
<?php $__env->startSection('content'); ?>
  <?php $__env->startComponent('dashboard.layouts.headers.auth'); ?>
    <?php $__env->startComponent('dashboard.layouts.headers.breadcrumbs'); ?>
      ...
      <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('Add Role')); ?></li>
        ...
        <div class="card">
          <div class="card-header">
            <div class="row align-items-center">
              <div class="col-8">
                <h3 class="mb-0"><?php echo e(__('Add Role')); ?></h3>
              </div>
          ...
          <div class="card-body">
            <form method="post" action="<?php echo e(route('lead.role.store')); ?>" autocomplete="off">
              <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard.layouts.app', [
  ...
  'parentSection' => 'users',
  'elementName' => 'role'
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mihz\Desktop\aekiti\resources\views/dashboard/lead/roles/create.blade.php ENDPATH**/ ?>