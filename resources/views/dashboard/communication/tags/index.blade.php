          ...
          <div class="card-header">
            <div class="row align-items-center">
              ...
              <div class="col-4 text-right">
                <a href="{{ route('communication.tag.create') }}" class="btn btn-sm btn-primary">{{ __('Add tag') }}</a>
              </div>
            </div>
          </div>
                    ...
                    <td class="text-right">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <a class="dropdown-item" href="{{ route('communication.tag.edit', $tag) }}">{{ __('Edit') }}</a>
                          @if ($tag->stories->isEmpty())
                            <form action="{{ route('communication.tag.destroy', $tag) }}" method="post">
                              @csrf
                              @method('delete')
