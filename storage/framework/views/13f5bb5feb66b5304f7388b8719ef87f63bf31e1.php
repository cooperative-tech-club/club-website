    ...
    <div class="row">
      ...
      <div class="col-xl-8 order-xl-1">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="post" action="<?php echo e(route('facilitator.profile.update')); ?>" autocomplete="off"
                ...
                <hr class="my-4" />
                <form method="post" action="<?php echo e(route('facilitator.profile.password')); ?>" autocomplete="off">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('put'); ?>
...
<?php echo $__env->make('dashboard.layouts.app', [
  ...
  'parentSection' => '',
  'elementName' => 'profile'
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mihz\Desktop\aekiti\resources\views/dashboard/facilitator/profile/edit.blade.php ENDPATH**/ ?>