...
class TrackController extends Controller
{
  ...
  {
    return view('dashboard.communication.tracks.index', ['tracks' => $model->with('tags')->get()]);
  }
  ...
  {
    return view('dashboard.communication.tracks.create', ['tags' => $tagModel->get(['id', 'name'])]);
  }
  ...
  public function store(TrackRequest $request, Track $model)
  {
    ...
    return redirect()->route('communication.track.index')->withStatus(__('Track successfully created.'));
  }
  ...
  {
    return view('dashboard.communication.tracks.edit', [
  ...
  public function update(TrackRequest $request, Track $track)
  {
    ...
    return redirect()->route('communication.track.index')->withStatus(__('Track successfully updated.'));
  }
