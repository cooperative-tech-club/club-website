    ...
    <div class="row">
      <div class="col-xl-12 order-xl-1">
        <div class="card">
          ...
          <div class="card-body">
            <form method="post" class="item-form" action="<?php echo e(route('lead.project.store')); ?>" autocomplete="off" enctype="multipart/form-data">
              <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard.layouts.app', [
  ...
  'parentSection' => 'site',
  'elementName' => 'project'
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mihz\Desktop\aekiti\resources\views/dashboard/lead/projects/create.blade.php ENDPATH**/ ?>