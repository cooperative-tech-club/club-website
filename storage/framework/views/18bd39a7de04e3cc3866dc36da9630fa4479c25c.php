            ...
            <div class="list-group list-group-flush">
              <a href="#!" class="list-group-item list-group-item-action">
                <div class="row align-items-center">
                  <div class="col-auto">
                    <img alt="Image placeholder" src="<?php echo e(asset('assets/images/icons/icon-512x512.png')); ?>" class="avatar rounded-circle">
                  </div>
                  <div class="col ml--2">
...
<?php /**PATH C:\Users\mihz\Desktop\club-website\resources\views/dashboard/lead/layouts/nav/navbar.blade.php ENDPATH**/ ?>