...
<?php $__env->startSection('content'); ?>
  <?php $__env->startComponent('dashboard.layouts.headers.auth'); ?>
    <?php $__env->startComponent('dashboard.layouts.headers.breadcrumbs'); ?>
      <li class="breadcrumb-item"><a href="<?php echo e(route('member.team.index')); ?>"><?php echo e(__('Team Management')); ?></a></li>
          ...
          <div class="card-header">
            <div class="row align-items-center">
              ...
              <div class="col-4 text-right">
                <a href="<?php echo e(route('member.team.create')); ?>" class="btn btn-sm btn-primary"><?php echo e(__('Add team')); ?></a>
              </div>
            </div>
          </div>
                    ...
                    <td class="text-right">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <a class="dropdown-item" href="<?php echo e(route('member.team.edit', $team)); ?>"><?php echo e(__('Edit')); ?></a>
                          <form action="<?php echo e(route('member.team.destroy', $team)); ?>" method="post">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard.layouts.app', [
  ...
  'parentSection' => 'users',
  'elementName' => 'team'
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mihz\Desktop\club-website\resources\views/dashboard/member/teams/index.blade.php ENDPATH**/ ?>