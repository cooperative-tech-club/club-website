          ...
          <div class="card-header">
            <div class="row align-items-center">
              ...
              <div class="col-4 text-right">
                <a href="{{ route('lead.venue.create') }}" class="btn btn-sm btn-primary">{{ __('Add venue') }}</a>
              </div>
            </div>
          </div>
                    ...
                    <td class="text-right">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <a class="dropdown-item" href="{{ route('lead.venue.edit', $venue) }}">{{ __('Edit') }}</a>
                          <form action="{{ route('lead.venue.destroy', $venue) }}" method="post">
                            @csrf
                            @method('delete')
