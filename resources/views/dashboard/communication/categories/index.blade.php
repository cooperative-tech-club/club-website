          ...
          <div class="card-header">
            <div class="row align-items-center">
              ...
              <div class="col-4 text-right">
                <a href="{{ route('communication.category.create') }}" class="btn btn-sm btn-primary">{{ __('Add category') }}</a>
              </div>
            </div>
          </div>
                    ...
                    <td class="text-right">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <a class="dropdown-item" href="{{ route('communication.category.edit', $category) }}">{{ __('Edit') }}</a>
                          <form action="{{ route('communication.category.destroy', $category) }}" method="post">
                            @csrf
                            @method('delete')
