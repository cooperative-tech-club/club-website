          ...
          <div class="card-header">
            <div class="row align-items-center">
              ...
              <div class="col-4 text-right">
                <a href="<?php echo e(route('media.story.create')); ?>" class="btn btn-sm btn-primary"><?php echo e(__('Add story')); ?></a>
              </div>
            </div>
          </div>
                    ...
                    <td class="text-right">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <a class="dropdown-item" href="<?php echo e(route('media.story.show', $story)); ?>"><?php echo e(__('Show')); ?></a>
                          <a class="dropdown-item" href="<?php echo e(route('media.story.edit', $story)); ?>"><?php echo e(__('Edit')); ?></a>
                          <form action="<?php echo e(route('media.story.destroy', $story)); ?>" method="post">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard.layouts.app', [
  ...
  'parentSection' => 'site',
  'elementName' => 'story'
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mihz\Desktop\aekiti\resources\views/dashboard/media/stories/index.blade.php ENDPATH**/ ?>