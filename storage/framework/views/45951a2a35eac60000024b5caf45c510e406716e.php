<?php $__env->startSection('pageTitle','Copa Tech - Track Management'); ?>
        ...
        <div class="card">
          <div class="card-header">
            <div class="row align-items-center">
              <div class="col-8">
                <h3 class="mb-0"><?php echo e(__('Tracks')); ?></h3>
                <p class="text-sm mb-0">
                  <?php echo e(__('This is an example of track management. This is a minimal setup in order to get started fast.')); ?>

                </p>
              </div>
              <div class="col-4 text-right">
                <a href="<?php echo e(route('lead.track.create')); ?>" class="btn btn-sm btn-primary"><?php echo e(__('Add track')); ?></a>
              </div>
            </div>
          </div>
                    ...
                    <td class="text-right">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <a class="dropdown-item" href="<?php echo e(route('lead.track.edit', $track)); ?>"><?php echo e(__('Edit')); ?></a>
                          <form action="<?php echo e(route('lead.track.destroy', $track)); ?>" method="post">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard.layouts.app', [
  ...
  'parentSection' => 'site',
  'elementName' => 'track'
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mihz\Desktop\aekiti\resources\views/dashboard/lead/tracks/index.blade.php ENDPATH**/ ?>