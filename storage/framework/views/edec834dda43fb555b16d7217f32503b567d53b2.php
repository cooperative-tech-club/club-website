<?php $__env->startSection('pageTitle','Copa Tech - Role Management'); ?>
          ...
          <div class="card-header">
            <div class="row align-items-center">
              ...
              <div class="col-4 text-right">
                <a href="<?php echo e(route('lead.role.create')); ?>" class="btn btn-sm btn-primary"><?php echo e(__('Add role')); ?></a>
            </div>
            </div>
          </div>
              ...
              <tbody>
                <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    ...
                    <td><?php echo e($role->created_at->format('l, M d, Y')); ?></td>
                    <td class="text-right">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <a class="dropdown-item" href="<?php echo e(route('lead.role.edit', $role)); ?>"><?php echo e(__('Edit')); ?></a>
                        </div>
                    </div>
                  </td>
                  </tr>
...
<?php echo $__env->make('dashboard.layouts.app', [
  ...
  'parentSection' => 'users',
  'elementName' => 'role'
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mihz\Desktop\aekiti\resources\views/dashboard/lead/roles/index.blade.php ENDPATH**/ ?>