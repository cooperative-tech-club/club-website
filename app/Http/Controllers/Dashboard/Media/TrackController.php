...
class TrackController extends Controller
{
  ...
  {
    return view('dashboard.media.tracks.index', ['tracks' => $model->with('tags')->get()]);
  }
  ...
  {
    return view('dashboard.media.tracks.create', ['tags' => $tagModel->get(['id', 'name'])]);
  }
  ...
  public function store(TrackRequest $request, Track $model)
  {
    ...
    return redirect()->route('media.track.index')->withStatus(__('Track successfully created.'));
  }
  ...
  {
    return view('dashboard.media.tracks.edit', [
  ...
  public function update(TrackRequest $request, Track $track)
  {
    ...
    return redirect()->route('media.track.index')->withStatus(__('Track successfully updated.'));
  }
  ...
  public function destroy(Track $track)
  {
    ...
    return redirect()->route('media.track.index')->withStatus(__('Track successfully deleted.'));
  }
}
