          ...
          <div class="card-header">
            <div class="row align-items-center">
              ...
              <div class="col-4 text-right">
                <a href="{{ route('communication.story.show', $story) }}" class="btn btn-sm btn-secondary mr-2">{{ __('See Story') }}</a>
                <a href="{{ route('communication.story.index') }}" class="btn btn-sm btn-primary">{{ __('Back to list') }}</a>
              </div>
            </div>
          </div>
          <div class="card-body">
            <form method="post" class="item-form" action="{{ route('communication.story.update', $story) }}" autocomplete="off" enctype="multipart/form-data">
              @csrf
              @method('put')
