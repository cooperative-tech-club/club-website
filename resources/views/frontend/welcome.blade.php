          ...
          <div class="hero-content">
            <div class="hero-title__group">
              <div class="hero-title">
                <h2 class="zuri">Cuk Developer Student Club<br> {{ config('app.info.location') }}.</h2>
              </div>
              <div class="Hero--Subtitle">
                <p class="lead">Cuk Developer Student Clubs is a
                  Developers program for university students to learn<second-letter> mobile </second-letter> and <first-letter>web development skills</first-letter> and <third-letter>design thinking skills</third-letter> 
                </p>
              </div>
            </div>
          ...
          <section id="hi" class="section-spacer bg-very__gray">
            <div class="container">
              <div class="row align-items-center">
                <div class="col-sm-6">
                  <div class="feature-list-image">
                    <img class="card-img-top" src="{{ asset('images/frontend/events/techmeet.png') }}" alt="Tech Workshop">
                ...
                <div class="col-sm-5 ml-auto">
                  <div class="feature-list-wrapper">
                    <div class="content-header">
                      <h2 class="content-title">Tech meet</h2>
                      <hr>
                      <h6>TIME : 10:00 AM - 02:00 PM (Fridays)</h6>
                      <h6>VENUE : MAIN HALL</h6>
            ...
            <div class="carousel-item col-md-4 col-15">
              <div class="card event-card">
                <div class="card hovercard">
                  <div class="cardheader"></div>
                  <div class="avatar">
                    <img src="{{ asset('images/frontend/team/avatar.png') }}" alt="lead avatar">
                  </div>
                  <div class="info">
                    <div class="title">
                      <h5>name</h5>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">How frequently do events and Meets occur?</h5>
              <p>We hold meets and showcases at the mainhall & we would recommend you to join our community by becoming a <a href="{{ route('register') }}">member</a> to get updates.</p>
            </div>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-sm-6">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">What should I carry when attending a meet?</h5>
