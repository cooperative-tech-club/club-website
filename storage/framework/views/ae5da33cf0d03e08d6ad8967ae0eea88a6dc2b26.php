      ...
      <div class="col-xl-3 col-md-6">
        <div class="card bg-gradient-info border-0">
          <div class="card-body">
            ...
            <p class="mt-3 mb-0 text-sm">
              <a href="<?php echo e(route('media.workshop.index')); ?>" class="text-nowrap text-white font-weight-600">See details</a>
            </p>
          </div>
        </div>
      </div>
      <div class="col-xl-3 col-md-6">
        <div class="card bg-gradient-danger border-0">
          <div class="card-body">
            ...
            <p class="mt-3 mb-0 text-sm">
              <a href="<?php echo e(route('media.track.index')); ?>" class="text-nowrap text-white font-weight-600">See details</a>
            </p>
          </div>
        </div>
      </div>
      <div class="col-xl-3 col-md-6">
        <div class="card bg-gradient-default border-0">
          <div class="card-body">
            ...
            <p class="mt-3 mb-0 text-sm">
              <a href="<?php echo e(route('media.story.index')); ?>" class="text-nowrap text-white font-weight-600">See details</a>
            </p>
          </div>
        </div>
      </div>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mihz\Desktop\club-website\resources\views/dashboard/media/dashboard.blade.php ENDPATH**/ ?>