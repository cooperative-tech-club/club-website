...
class VenueController extends Controller
{
  ...
  {
    return view('dashboard.media.venues.index', ['venues' => $model->all()]);
  }
  ...
  {
    return view('dashboard.media.venues.create');
  }
  ...
  public function store(VenueRequest $request, Venue $model)
  {
    ...
    return redirect()->route('media.venue.index')->withStatus(__('Venue successfully created.'));
  }
  ...
  {
    return view('dashboard.media.venues.edit', compact('venue'));
  }
  ...
  public function destroy(Venue $venue)
  {
    if (!$venue->workshops->isEmpty()) {
      return redirect()->route('media.venue.index')->withErrors(__('This venue has workshops attached and can\'t be deleted.'));
    }

    $venue->delete();

    return redirect()->route('media.venue.index')->withStatus(__('Venue successfully deleted.'));
  }
}
