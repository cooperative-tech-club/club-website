...
<?php $__env->startSection('content'); ?>
  <?php $__env->startComponent('dashboard.layouts.headers.auth'); ?>
    <?php $__env->startComponent('dashboard.layouts.headers.breadcrumbs'); ?>
      <li class="breadcrumb-item"><a href="<?php echo e(route('lead.story.index')); ?>"><?php echo e(__('Story Management')); ?></a></li>
          ...
          <div class="card-header">
            <div class="row align-items-center">
              ...
              <div class="col-4 text-right">
                <a href="<?php echo e(route('lead.story.show', $story)); ?>" class="btn btn-sm btn-secondary mr-2"><?php echo e(__('See Story')); ?></a>
                <a href="<?php echo e(route('lead.story.index')); ?>" class="btn btn-sm btn-primary"><?php echo e(__('Back to list')); ?></a>
              </div>
            </div>
          </div>
          <div class="card-body">
            <form method="post" class="item-form" action="<?php echo e(route('lead.story.update', $story)); ?>" autocomplete="off" enctype="multipart/form-data">
              <?php echo csrf_field(); ?>
              ...
              <div class="pl-lg-4">
                <div class="form-group<?php echo e($errors->has('title') ? ' has-danger' : ''); ?>">
                  ...
                  <input type="text" name="title" id="input-title" class="form-control<?php echo e($errors->has('title') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Title')); ?>" value="<?php echo e(old('title', $story->title)); ?>"  autofocus>
                ...
                <div class="form-group<?php echo e($errors->has('slug') ? ' has-danger' : ''); ?>">
                  ...
                  <input type="text" name="slug" id="input-slug" class="form-control<?php echo e($errors->has('slug') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Slug')); ?>" value="<?php echo e(old('slug', $story->slug)); ?>">
                ...
                <div class="form-group<?php echo e($errors->has('category_id') ? ' has-danger' : ''); ?>">
                  ...
                  <select name="category_id" id="input-role" class="form-control<?php echo e($errors->has('category_id') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Category')); ?>" >
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($category->id); ?>" <?php echo e($category->id == old('category_id', $story->category_id) ? 'selected' : ''); ?>><?php echo e($category->name); ?></option>
                ...
                <div class="form-group<?php echo e($errors->has('excerpt') ? ' has-danger' : ''); ?>">
                  ...
                  <textarea name="excerpt" id="input-excerpt" cols="30" rows="2" class="form-control<?php echo e($errors->has('excerpt') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Excerpt')); ?>" value="<?php echo e(old('excerpt')); ?>"><?php echo e(old('excerpt', $story->excerpt)); ?></textarea>
                ...
                <div class="form-group<?php echo e($errors->has('article') ? ' has-danger' : ''); ?>">
                  ...
                  <textarea name="article" id="compose-textarea" class="form-control<?php echo e($errors->has('article') ? ' is-invalid' : ''); ?>"><?php echo e(old('article', $story->article)); ?></textarea>
                ...
                <div class="form-group<?php echo e($errors->has('tags') ? ' has-danger' : ''); ?>">
                  ...
                  <select name="tags[]" id="input-role" class="form-control select2<?php echo e($errors->has('tags') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Tags')); ?>" data-toggle="select"  multiple>
                    <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($tag->id); ?>" <?php echo e(in_array($tag->id, old('tags', $story->tags->pluck('id')->toArray()) ?? []) ? 'selected' : ''); ?>><?php echo e($tag->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
                ...
                <div class="form-group<?php echo e($errors->has('status') ? ' has-danger' : ''); ?>">
                  ...
                  <?php $__currentLoopData = config('aekiti.stories'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="custom-control custom-radio mb-3">
                      <input name="status" class="custom-control-input" id="<?php echo e($value); ?>" value="<?php echo e($value); ?>" type="radio" <?php echo e(old('status', $story->status) == $value ? ' checked=checked' : ''); ?> onclick="showDate('<?php echo e($value); ?>')">
                ...
                <div class="row" id="show_date">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input class="form-control datepicker" name="published_date" id="published_date"  placeholder="Select published date" type="text" data-date-format="dd-mm-yyyy" value="<?php echo e(old('published_date', $story->published_date ? \Carbon\Carbon::parse($story->published_date)->format('d-m-Y') : '')); ?>">
                    </div>
                  </div>
                </div>
...
<?php echo $__env->make('dashboard.layouts.app', [
  ...
  'parentSection' => 'site',
  'elementName' => 'story'
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mihz\Desktop\aekiti\resources\views/dashboard/lead/stories/edit.blade.php ENDPATH**/ ?>