<?php $__env->startSection('pageTitle','Copa Tech - Edit venue'); ?>
...
<?php $__env->startSection('content'); ?>
  <?php $__env->startComponent('dashboard.layouts.headers.auth'); ?>
    <?php $__env->startComponent('dashboard.layouts.headers.breadcrumbs'); ?>
      <li class="breadcrumb-item"><a href="<?php echo e(route('lead.venue.index')); ?>"><?php echo e(__('Venue Management')); ?></a></li>
      <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('Edit venue')); ?></li>
          ...
          <div class="card-header">
            <div class="row align-items-center">
              ...
              <div class="col-4 text-right">
                <a href="<?php echo e(route('lead.venue.index')); ?>" class="btn btn-sm btn-primary"><?php echo e(__('Back to list')); ?></a>
              </div>
            </div>
          </div>
          <div class="card-body">
            <form method="post" action="<?php echo e(route('lead.venue.update', $venue)); ?>" autocomplete="off">
              <?php echo csrf_field(); ?>
              ...
              <div class="pl-lg-4">
                <div class="form-group<?php echo e($errors->has('name') ? ' has-danger' : ''); ?>">
                  ...
                  <input type="text" name="name" id="input-name" class="form-control<?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Name')); ?>" value="<?php echo e(old('name', $venue->name)); ?>" required autofocus>
                ...
                <div class="form-group<?php echo e($errors->has('address') ? ' has-danger' : ''); ?>">
                  ...
                  <input type="text" name="address" id="input-address" class="form-control<?php echo e($errors->has('address') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Address')); ?>" value="<?php echo e(old('address', $venue->address)); ?>" required>
                ...
                <div class="form-group<?php echo e($errors->has('locality') ? ' has-danger' : ''); ?>">
                  ...
                  <input type="text" name="locality" id="input-locality" class="form-control<?php echo e($errors->has('locality') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Locality')); ?>" value="<?php echo e(old('locality', $venue->locality)); ?>" required>
                ...
                <div class="form-group<?php echo e($errors->has('postal') ? ' has-danger' : ''); ?>">
                  ...
                  <input type="text" name="postal" id="input-postal" class="form-control<?php echo e($errors->has('postal') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Postal')); ?>" value="<?php echo e(old('postal', $venue->postal)); ?>" required>
                ...
                <div class="form-group<?php echo e($errors->has('region') ? ' has-danger' : ''); ?>">
                  ...
                  <input type="text" name="region" id="input-region" class="form-control<?php echo e($errors->has('region') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Region')); ?>" value="<?php echo e(old('region', $venue->region)); ?>" required>
                ...
                <div class="form-group<?php echo e($errors->has('country') ? ' has-danger' : ''); ?>">
                  ...
                  <input type="text" name="country" id="input-country" class="form-control<?php echo e($errors->has('country') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Country')); ?>" value="<?php echo e(old('country', $venue->country)); ?>" required>
                ...
                <div class="form-group<?php echo e($errors->has('link') ? ' has-danger' : ''); ?>">
                  ...
                  <input type="url" name="link" id="input-link" class="form-control<?php echo e($errors->has('link') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Link')); ?>" value="<?php echo e(old('link', $venue->link)); ?>" required>
                ...
                <div class="form-group<?php echo e($errors->has('map') ? ' has-danger' : ''); ?>">
                  ...
                  <input type="url" name="map" id="input-map" class="form-control<?php echo e($errors->has('map') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Map')); ?>" value="<?php echo e(old('map', $venue->map)); ?>" required>
...
<?php echo $__env->make('dashboard.layouts.app', [
  ...
  'elementName' => 'venue'
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mihz\Desktop\aekiti\resources\views/dashboard/lead/venues/edit.blade.php ENDPATH**/ ?>