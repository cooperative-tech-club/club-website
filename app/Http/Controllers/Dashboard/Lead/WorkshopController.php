...
class WorkshopController extends Controller
{
  ...
  {
    return view('dashboard.lead.workshops.index', ['workshops' => $model->with(['tags', 'venue'])->get()]);
  }
  ...
  {
    return view('dashboard.lead.workshops.create', [
  ...
  public function store(WorkshopRequest $request, Workshop $model)
  {
    ...
    return redirect()->route('lead.workshop.index')->withStatus(__('Workshop successfully created.'));
  }
  ...
  {
    return view('dashboard.lead.workshops.edit', [
  ...
  public function update(WorkshopRequest $request, Workshop $workshop)
  {
    ...
    return redirect()->route('lead.workshop.index')->withStatus(__('Workshop successfully updated.'));
  }
  ...
  public function destroy(Workshop $workshop)
  {
    ...
    return redirect()->route('lead.workshop.index')->withStatus(__('Workshop successfully deleted.'));
  }
}
