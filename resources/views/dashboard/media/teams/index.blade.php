          ...
          <div class="card-header">
            <div class="row align-items-center">
              ...
              <div class="col-4 text-right">
                <a href="{{ route('media.team.create') }}" class="btn btn-sm btn-primary">{{ __('Add team') }}</a>
              </div>
            </div>
          </div>
                    ...
                    <td class="text-right">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <a class="dropdown-item" href="{{ route('media.team.edit', $team) }}">{{ __('Edit') }}</a>
                          <form action="{{ route('media.team.destroy', $team) }}" method="post">
                            @csrf
                            @method('delete')
