          ...
          <div class="card-header">
            <div class="row align-items-center">
              ...
              <div class="col-4 text-right">
                <a href="{{ route('media.story.create') }}" class="btn btn-sm btn-primary">{{ __('Add story') }}</a>
              </div>
            </div>
          </div>
                    ...
                    <td class="text-right">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <a class="dropdown-item" href="{{ route('media.story.show', $story) }}">{{ __('Show') }}</a>
                          <a class="dropdown-item" href="{{ route('media.story.edit', $story) }}">{{ __('Edit') }}</a>
                          <form action="{{ route('media.story.destroy', $story) }}" method="post">
                            @csrf
                            @method('delete')
