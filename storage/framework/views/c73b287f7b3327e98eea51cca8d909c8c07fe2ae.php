      ...
      <div class="header-body">
        <div class="row align-items-center py-4">
          <div class="col-lg-6 col-7">
            <h6 class="h2 d-inline-block mb-0">Member Dashboard</h6>
      ...
      <div class="col-xl-3 col-md-6">
        <div class="card bg-gradient-danger border-0">
          <div class="card-body">
            ...
            <p class="mt-3 mb-0 text-sm">
             <a href="<?php echo e(route('member.track.index')); ?>" class="text-nowrap text-white font-weight-600">See details</a>
            </p>
          </div>
        </div>
      </div>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mihz\Desktop\club-website\resources\views/dashboard/member/dashboard.blade.php ENDPATH**/ ?>