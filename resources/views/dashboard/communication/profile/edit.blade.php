...
@section('pageTitle','Copa Tech - User Profile')
    ...
    <div class="row">
      <div class="col-xl-4 order-xl-2">
        <div class="card card-profile">
            <img src="{{ asset('assets/images/web/brand/logo_text.png') }}" alt="{{ config('app.nick') }}" class="card-img-top">
            <div class="row justify-content-center">
                <div class="col-lg-3 order-lg-2">
                    <div class="card-profile-image">
                        <a href="#">
                            <img src="{{ config('app.url') . auth()->user()->profilePicture() }}" class="rounded-circle">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body pt-0">
                ...
                <div class="text-center">
                    <h5 class="h3">
                        {{ auth()->user()->name }}<span class="font-weight-light">, {{ auth()->user()->id }}</span>
                    </h5>
                        ...
                        <div class="row align-items-center">
                            <div class="col-auto">
                                ...
                                <a href="#" class="avatar rounded-circle">
                                    <img alt="Image placeholder" src="{{ asset('assets/dashboard') }}/img/theme/bootstrap.jpg">
                                </a>
                            </div>
                            <div class="col">
                    ...
                    <li class="list-group-item px-0">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <!-- Avatar -->
                                <a href="#" class="avatar rounded-circle">
                                    <img alt="Image placeholder" src="{{ asset('assets/dashboard') }}/img/theme/angular.jpg">
                                </a>
                            </div>
                            <div class="col">
                    ...
                    <li class="list-group-item px-0">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <!-- Avatar -->
                                <a href="#" class="avatar rounded-circle">
                                    <img alt="Image placeholder" src="{{ asset('assets/dashboard') }}/img/theme/sketch.jpg">
                                </a>
                            </div>
                            <div class="col">
                    ...
                    <li class="list-group-item px-0">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <!-- Avatar -->
                                <a href="#" class="avatar rounded-circle">
                                    <img alt="Image placeholder" src="{{ asset('assets/dashboard') }}/img/theme/react.jpg">
                                </a>
                            </div>
                            <div class="col">
                    ...
                    <li class="list-group-item px-0">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <!-- Avatar -->
                                <a href="#" class="avatar rounded-circle">
                                    <img alt="Image placeholder" src="{{ asset('assets/dashboard') }}/img/theme/vue.jpg">
                                </a>
                            </div>
                            <div class="col">
      ...
      <div class="col-xl-8 order-xl-1">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="post" action="{{ route('communication.profile.update') }}" autocomplete="off"
                ...
                <hr class="my-4" />
                <form method="post" action="{{ route('communication.profile.password') }}" autocomplete="off">
                    @csrf
                    @method('put')
