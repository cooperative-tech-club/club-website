<?php $__env->startSection('pageTitle','Copa Tech - Lead Dashboard'); ?>
      ...
      <div class="header-body">
        <div class="row align-items-center py-4">
          <div class="col-lg-6 col-7">
            <h6 class="h2 d-inline-block mb-0">Lead Dashboard</h6>
        ...
        <div class="card bg-gradient-primary border-0">
          <div class="card-body">
            ...
            <p class="mt-3 mb-0 text-sm">
              <a href="<?php echo e(route('lead.user.index')); ?>" class="text-nowrap text-white font-weight-600">See details</a>
            </p>
          </div>
        </div>
      </div>
      <div class="col-xl-3 col-md-6">
        <div class="card bg-gradient-info border-0">
          <div class="card-body">
            ...
            <p class="mt-3 mb-0 text-sm">
              <a href="<?php echo e(route('lead.workshop.index')); ?>" class="text-nowrap text-white font-weight-600">See details</a>
            </p>
          </div>
        </div>
      </div>
          ...
          <div class="card-body">
            <div class="row">
              <div class="col">
                ...
                <span class="h2 font-weight-bold mb-0 text-white"><?php echo e($projects->count()); ?></span>
              </div>
            </div>
            <p class="mt-3 mb-0 text-sm">
              <a href="<?php echo e(route('lead.project.index')); ?>" class="text-nowrap text-white font-weight-600">See details</a>
            </p>
          </div>
        </div>
      </div>
      <div class="col-xl-3 col-md-6">
        <div class="card bg-gradient-default border-0">
          <div class="card-body">
            ...
            <p class="mt-3 mb-0 text-sm">
              <a href="<?php echo e(route('lead.story.index')); ?>" class="text-nowrap text-white font-weight-600">See details</a>
            </p>
          </div>
        </div>
      </div>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mihz\Desktop\club-website\resources\views/dashboard/lead/dashboard.blade.php ENDPATH**/ ?>