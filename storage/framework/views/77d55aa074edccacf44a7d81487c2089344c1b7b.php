<?php $__env->startSection('pageTitle','Copa Tech - Terms & Conditions'); ?>
<?php $__env->startSection('pageDescription', 'These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity (you), and Copa Tech Club'); ?>
    ...
    <div class="container">
      <div class="justify-content-center">
        <div>
          ...
          <p>1.1  These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity (you), and Copa Tech Club, located at Karen ,Nairobi, Kenya. (we, us), concerning your access to and use of the <span class="text-primary">Copa Tech Club</span> (<a href="https://CopaTech.com" target="blank">https://CopaTech.com</a>) website as well as any related applications (the Site).</p>
          <p>The Site is an online community of developers, writers, digital designers & entrepreneurs interested in learning about and developing solutions using æternity technologies. (Services). You agree that by accessing the Site and/or Services, you have read, understood, and agree to be bound by all of these Terms and Conditions.</p>
          ...
          <p>1.4  We may update or change the Site from time to time to reflect changes to our services, our users' needs and/or our community priorities.</p>
          <p>1.5  Our site is directed to people residing in Nigeria. The information provided on the Site is not intended for distribution to or use by any person or entity in any jurisdiction or country where such distribution or use would be contrary to law or regulation or which would subject us to any registration requirement within such jurisdiction or country.</p>
          ...
          <p>
            ...
            <ul>
              <li>Our Privacy Policy <a href="https://CopaTech.com/privacy" target="blank">https://CopaTech.com/privacy</a>, which sets out the terms on which we process any personal data we collect from you, or that you provide to us. By using the Site, you consent to such processing and you warrant that all data provided by you is accurate.</li>
            </ul>
          </p>
        </div>
        ...
        <div>
          ...
          <p>2.1  Our full Acceptable Use Policy, sets out all the permitted uses and prohibited uses of this site.</p>
        ...
        <div>
          ...
          <p>4.2  You further agree that we can use your User Content for any other purposes whatsoever in perpetuity without payment to you, and combine your User Content with other content for use within the Site and otherwise. We do not have to attribute your User Content to you.</p>
          ...
          <p>4.7  If you wish to complain about User Content uploaded by other users please contact us at <a href="mailto:contact@CopaTech.com" target="_blank">contact@CopaTech.com</a>.</p>
        </div>

        <div>
          <h4>5. Our content</h4>
          <p>5.1  Unless otherwise indicated, the Site and Services including source code, databases, functionality, software, website designs, audio, video, text, photographs, and graphics on the Site (Our Content) are owned or licensed to us, and are protected by copyright laws.</p>
        ...
        <div>
          ...
          <p>
            9.2  Our responsibility for loss or damage suffered by you:<br><br>Whether you are a developer or a designer user:
            <ul>
            ...
            If you are an entrepreneur user:
            <ul>
        ...
        <div>
          ...
          <p>11.8  For entrepreneur only  - Please note that these Terms and Conditions, their subject matter and their formation, are governed by English law. You and we both agree that the courts of Nigeria will have exclusive jurisdiction. If you have any complaint or wish to raise a dispute under these Terms and Conditions or otherwise in relation to the Site please send a mail to <a href="mailto:contact@CopaTech.com" target="_blank">contact@CopaTech.com</a></p>
...
<?php echo $__env->make('web.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mihz\Desktop\aekiti\resources\views/web/terms.blade.php ENDPATH**/ ?>