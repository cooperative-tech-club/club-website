          ...
          <div class="card-header">
            <div class="row align-items-center">
              ...
              <div class="col-4 text-right">
                <a href="<?php echo e(route('media.venue.create')); ?>" class="btn btn-sm btn-primary"><?php echo e(__('Add venue')); ?></a>
              </div>
            </div>
          </div>
                    ...
                    <td class="text-right">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <a class="dropdown-item" href="<?php echo e(route('media.venue.edit', $venue)); ?>"><?php echo e(__('Edit')); ?></a>
                          <form action="<?php echo e(route('media.venue.destroy', $venue)); ?>" method="post">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard.layouts.app', [
  ...
  'elementName' => 'venue'
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mihz\Desktop\aekiti\resources\views/dashboard/media/venues/index.blade.php ENDPATH**/ ?>