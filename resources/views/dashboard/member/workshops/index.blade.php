          ...
          <div class="card-header">
            <div class="row align-items-center">
              ...
              <div class="col-4 text-right">
                <a href="{{ route('member.workshop.create') }}" class="btn btn-sm btn-primary">{{ __('Add workshop') }}</a>
              </div>
            </div>
          </div>
                    ...
                    <td class="text-right">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <a class="dropdown-item" href="{{ route('member.workshop.edit', $workshop) }}">{{ __('Edit') }}</a>
                          <form action="{{ route('member.workshop.destroy', $workshop) }}" method="post">
                            @csrf
                            @method('delete')
