<?php $__env->startSection('pageTitle','Copa Tech - Add Track'); ?>
...
<?php $__env->startSection('content'); ?>
  <?php $__env->startComponent('dashboard.layouts.headers.auth'); ?>
    <?php $__env->startComponent('dashboard.layouts.headers.breadcrumbs'); ?>
      ...
      <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('Add Track')); ?></li>
    ...
    <div class="row">
      <div class="col-xl-12 order-xl-1">
        <div class="card">
          ...
          <div class="card-body">
            <form method="post" class="item-form" action="<?php echo e(route('lead.track.store')); ?>" autocomplete="off" enctype="multipart/form-data">
              <?php echo csrf_field(); ?>
              ...
              <div class="pl-lg-4">
                ...
                <div class="form-group<?php echo e($errors->has('source') ? ' has-danger' : ''); ?>">
                  ...
                  <input type="text" name="source" id="input-source" class="form-control<?php echo e($errors->has('source') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Source')); ?>" value="<?php echo e(old('source')); ?>" required>
...
<?php echo $__env->make('dashboard.layouts.app', [
  ...
  'parentSection' => 'site',
  'elementName' => 'track'
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mihz\Desktop\aekiti\resources\views/dashboard/lead/tracks/create.blade.php ENDPATH**/ ?>