...
class TeamController extends Controller
{
  ...
  {
    return view('dashboard.member.teams.index', ['teams' => $model->with('user')->get()]);
  }
  ...
  {
    return view('dashboard.member.teams.create', ['users' => $userModel->get(['id', 'name', 'email'])]);
  }
  ...
  public function store(TeamRequest $request, Team $model)
  {
    ...
    return redirect()->route('member.team.index')->withStatus(__('Team member successfully created.'));
  }
  ...
  {
    return view('dashboard.member.teams.edit', [
  ...
  public function update(TeamRequest $request, Team $team)
  {
    ...
    return redirect()->route('member.team.index')->withStatus(__('Team member successfully updated.'));
  }
  ...
  public function destroy(Team $team)
  {
    ...
    return redirect()->route('member.team.index')->withStatus(__('Team member successfully deleted.'));
  }
}
