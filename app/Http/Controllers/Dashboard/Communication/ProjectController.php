...
class ProjectController extends Controller
{
  ...
  {
    return view('dashboard.communication.projects.index', ['projects' => $model->with(['tags', 'category'])->get()]);
  }
  ...
  {
    return view('dashboard.communication.projects.create', [
  ...
  public function store(ProjectRequest $request, Project $model)
  {
    ...
    return redirect()->route('communication.project.index')->withStatus(__('Project successfully created.'));
  }
  ...
  {
    return view('dashboard.communication.projects.edit', [
  ...
  public function update(ProjectRequest $request, Project $project)
  {
    ...
    return redirect()->route('communication.project.index')->withStatus(__('Project successfully updated.'));
  }
  ...
  public function destroy(Project $project)
  {
    ...
    return redirect()->route('communication.project.index')->withStatus(__('Project successfully deleted.'));
  }
}
