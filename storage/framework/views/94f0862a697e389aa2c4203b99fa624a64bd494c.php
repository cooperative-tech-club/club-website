<?php $__env->startSection('pageTitle', 'CopaTechClub - Offline'); ?>
      ...
      <div class="row align-items-center">
          ...
          <div class="hero-content">
            <div class="hero-title__group">
              <div class="hero-title">
                <h2 class="zuri"><?php echo e(config('app.name')); ?><br> <?php echo e(config('app.nick')); ?>.</h2>
              </div>
        ...
        <div class="col-12 col-sm-5 ml-auto ml-pic">
          <div class="hero-figure">
            <img src="<?php echo e(asset('assets/images/web/diversity.png')); ?>" class="img-fluid w-100" alt="Illustration of diversity in our community">
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="carousel-item col-md-4 col-15 active">
              <div class="card event-card">
                <div class="card hovercard">
                  ...
                  <div class="avatar">
                    <img src="<?php echo e(asset('assets/images/web/team/emmanuel_joseph_jet.png')); ?>" alt="lead avatar">
                  </div>
                  <div class="info">
                    <div class="title">
                      <h5>Jeremih</h5>
            ...
            <div class="carousel-item col-md-4 col-15">
              <div class="card event-card">
                <div class="card hovercard">
                  <div class="cardheader"></div>
                  <div class="avatar">
                    <img src="<?php echo e(asset('assets/images/web/team/jesulonimi_akingbesote.png')); ?>" alt="co-organizer avatar">
                  </div>
                  <div class="info">
                    <div class="title">
            ...
            <div class="carousel-item col-md-4 col-15">
              <div class="card event-card">
                <div class="card hovercard">
                  <div class="cardheader"></div>
                  <div class="avatar">
                    <img src="<?php echo e(asset('assets/images/web/team/moritz_stellmacher.png')); ?>" alt="mentor avatar">
                  </div>
                  <div class="info">
                    <div class="title">
                      <h5>Celine Bowen</h5>
            ...
            <div class="carousel-item col-md-4 col-15">
              <div class="card event-card">
                <div class="card hovercard">
                  <div class="cardheader"></div>
                  <div class="avatar">
                    <img src="<?php echo e(asset('assets/images/web/team/stephen_sunday.png')); ?>" alt="mentor avatar">
                  </div>
                  <div class="info">
                    <div class="title">
                      <h5>Mr shem.......................</h5>
...
<?php echo $__env->make('web.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mihz\Desktop\aekiti\resources\views/modules/laravelpwa/offline.blade.php ENDPATH**/ ?>