...
class StoryController extends Controller
{
  ...
  {
    return view('dashboard.communication.stories.index', ['stories' => $model->with(['tags', 'category'])->get()]);
  }
  ...
  {
    return view('dashboard.communication.stories.create', [
  ...
  public function store(StoryRequest $request, Story $model)
  {
    ...
    return redirect()->route('communication.story.index')->withStatus(__('Story successfully created.'));
  }
  ...
  {
    return view('dashboard.communication.stories.show', [
  ...
  {
    return view('dashboard.communication.stories.edit', [
      'story' => $story->load('tags'),
      'tags' => $tagModel->get(['id', 'name']),
      'categories' => $categoryModel->get(['id', 'name'])
    ]);
  ...
  public function update(StoryRequest $request, Story $story)
  {
    ...
    return redirect()->route('communication.story.index')->withStatus(__('Story successfully updated.'));
  }
  ...
  public function destroy(Story $story)
  {
    ...
    return redirect()->route('communication.story.index')->withStatus(__('Story successfully deleted.'));
  }
}
