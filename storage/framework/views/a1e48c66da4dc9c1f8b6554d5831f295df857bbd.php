...
<?php $__env->startSection('content'); ?>
  <?php $__env->startComponent('dashboard.layouts.headers.auth'); ?>
    <?php $__env->startComponent('dashboard.layouts.headers.breadcrumbs'); ?>
      <li class="breadcrumb-item"><a href="<?php echo e(route('media.tag.index')); ?>"><?php echo e(__('Tag Management')); ?></a></li>
          ...
          <div class="card-header">
            <div class="row align-items-center">
              ...
              <div class="col-4 text-right">
                <a href="<?php echo e(route('media.tag.create')); ?>" class="btn btn-sm btn-primary"><?php echo e(__('Add tag')); ?></a>
              </div>
            </div>
          </div>
                    ...
                    <td class="text-right">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <a class="dropdown-item" href="<?php echo e(route('media.tag.edit', $tag)); ?>"><?php echo e(__('Edit')); ?></a>
                          <?php if($tag->stories->isEmpty()): ?>
                            <form action="<?php echo e(route('media.tag.destroy', $tag)); ?>" method="post">
                              <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard.layouts.app', [
  ...
  'elementName' => 'tag'
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mihz\Desktop\aekiti\resources\views/dashboard/media/tags/index.blade.php ENDPATH**/ ?>